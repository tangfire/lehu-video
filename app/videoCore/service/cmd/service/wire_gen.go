...
func wireApp(confServer *conf.Server, idgen *conf.Idgen, registry *conf.Registry, confData *conf.Data, logger log.Logger) (*kratos.App, func(), error) {
	...
	videoUsecase := biz.NewVideoUsecase(videoRepo, userCounterRepo, videoCounterRepo, feedUsecase, recentViewedManager, client, logger)
	...
	favoriteUsecase := biz.NewFavoriteUsecase(favoriteRepo, videoRepo, userCounterRepo, videoCounterRepo, client, generator, kafkaProducer, logger)

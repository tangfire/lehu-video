...
import (
	...
	logger2 "lehu-video/app/campusApi/service/internal/pkg/logger"
...
var (
	...
	Name string = "campus-estation.api.service"
...
func newApp(logger log.Logger, rr registry.Registrar, hs *http.Server, cts *server.CampusTaskServer) *kratos.App {
	return kratos.New(
		kratos.ID(id),
		kratos.Name(Name),

...
func wireApp(confServer *conf.Server, registry *conf.Registry, confData *conf.Data, auth *conf.Auth, logger log.Logger) (*kratos.App, func(), error) {
	...
	coreAdapter := data.NewCoreAdapter(userServiceClient, videoServiceClient, collectionServiceClient, commentServiceClient, favoriteServiceClient, followServiceClient, logger)
	...
	userUsecase := biz.NewUserUsecase(baseAdapter, coreAdapter, chatAdapter, logger)

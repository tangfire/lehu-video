...
11. [观测与告警](observability-alerting.md)：解释 Grafana、Loki、Alloy、Prometheus、health-exporter 和飞书告警怎么工作、怎么查日志、怎么处理告警。
12. [微信小程序提审与社区规则](wechat-submission.md)：隐私保护指引、社区规范、合法域名和提审验收清单。

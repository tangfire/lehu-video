...
| COS 标准存储 50GB | 45.31 元/年 | 日常价约 70.8 元/年 | 推荐购买，用作帖子图片、头像、反馈图片等公开对象存储 |
...
| 方案 | 首年现金成本 | 月均折算 | 说明 |
| --- | --- | --- | --- |
| 必买低成本首发 | 约 641 到 691 元/年 | 约 54 到 58 元/月 | 服务器 188 + MySQL 59 + COS 45.31 + CDN 16 + 域名 33 到 83 + 微信认证 300 |
| 加 AI 预算后 | 约 881 到 931 元/年 | 约 74 到 78 元/月 | 在必买基础上预留 AI/Agent/e仔最高 240 元/年 |
| 加 100GB 云硬盘后 | 约 979 到 1029 元/年 | 约 82 到 86 元/月 | 如果想让 Docker/Loki/Qdrant 数据盘更宽裕，可选 |

建议首发按“必买 + AI 预算”准备约 1000 元第一年预算；如果想更稳，再加 100GB 云硬盘，第一年也大约 1000 元出头。第二年续费要重新看服务器、域名和数据库续费价，不能只按首年活动价外推。以上不含后续推广、人力、付费图片审核、短信验证码和额外备案服务成本。
